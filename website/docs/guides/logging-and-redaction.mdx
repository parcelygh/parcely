...
postalservice automatically redacts sensitive header values in:
...
Axios does not redact sensitive headers in errors or responses. In postalservice, redaction is built in.
