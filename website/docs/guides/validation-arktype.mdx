...
ArkType 2+ implements Standard Schema v1, so it works with postalservice's `validate` option out of the box.
...
- ArkType is a dependency of your app, not of postalservice.
